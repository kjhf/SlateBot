...
{
  public class ResponseListCommand : Command
  {
    ...
    public ResponseListCommand(Language.LanguageHandler languageHandler, IEnumerable<string> aliases, string[][] choices, string choiceFormat, string examples, string help, ModuleType module, ResponseType responseType, bool requiresSymbol = true)
    {
    ...
    public override CommandHandlerType CommandHandlerType => CommandHandlerType.ResponseList;
