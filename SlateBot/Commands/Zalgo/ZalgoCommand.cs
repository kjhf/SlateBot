...
{
  public class ZalgoCommand : Command
  {
    internal ZalgoCommand(string[] aliases, string examples, string help, ModuleType module)
      : base(CommandHandlerType.Zalgo, aliases, examples, help, module)
    {
    }
